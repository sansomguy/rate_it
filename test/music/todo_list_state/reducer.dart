...
//
//    var state = mediaListReducer(MediaListState(media: [MediaItem(id: 1, title: 'test', completed: false)].toList()), CompleteTodoListItemAction(1));
//
//    var item = state.media.firstWhere((MediaItem item) => item.id == 1);
//
